...
namespace CTS
{
    ...
    public class CTSProfile : ScriptableObject
    {
        ...
        public bool NeedsArrayUpdate()
        {
            ...
            {
                #if !UNITY_WEBGL && !UNITY_WII && !UNITY_2018_1_OR_NEWER
        ...
        private Texture2D BakeHAOTexture(string name, Texture2D hTexture, Texture2D aoTexture, out byte minHeight, out byte maxHeight)
        {
            ...
            if (hTexture != null)
            {
                ...
                minHeight = 0xFF;
                maxHeight = 0x00;
                Texture2D tmpHTexture = ResizeTexture(hTexture, m_albedoFormat, m_albedoAniso, m_albedoTextureSizePx, m_albedoTextureSizePx, false, false, false);
            ...
            if (aoTexture != null)
            {
                Texture2D tmpAOTexture = ResizeTexture(aoTexture, m_albedoFormat, m_albedoAniso, m_albedoTextureSizePx, m_albedoTextureSizePx, false, false, false);
        ...
        private Texture2D BakeNormal(Texture2D normalTexture)
        {
            ...
            Color32[] target = newTexture.GetPixels32();
            Texture2D tmpNormalTexture = ResizeTexture(normalTexture, m_normalFormat, m_normalAniso, m_normalTextureSizePx, m_normalTextureSizePx, false, true, false);
        ...
        private Texture2D BakeAlbedo(Texture2D albedoTexture, Texture2D smoothnessTexture, Texture2D roughnessTexture)
        {
            ...
            {
                Texture2D tmpAlbedoTexture = ResizeTexture(albedoTexture, m_albedoFormat, m_albedoAniso, m_albedoTextureSizePx, m_albedoTextureSizePx, false, false, false);
            ...
            {
                Texture2D tmpRTexture = ResizeTexture(roughnessTexture, m_albedoFormat, m_albedoAniso, m_albedoTextureSizePx, m_albedoTextureSizePx, false, false, false);
            ...
            {
                Texture2D tmpSTexture = ResizeTexture(smoothnessTexture, m_albedoFormat, m_albedoAniso, m_albedoTextureSizePx, m_albedoTextureSizePx, false, false, false);
